<template>
  ...
  <div slot="table" class="right_table">
    <div>
      <edu-query ext="boxZybmbj" bjStart="s." :nianji="false" ref="cwQuery" code="veStuStipend" :do-filter="handleFilter">
        <template slot="search">
          ...
          <edu-query-item title="审核状态" code="xjAuditStatus" pname="audit_status" pop="eq" stype="select"> </edu-query-item>
        </template>
      </edu-query>
      <edu-table
        ...
        :doImport="viewType == 'shen' ? null : doImport"
        :exportConfig="
          viewType == 'shen'
            ? null
            : {
        ...
        :config="{
          ...
          close: false,
          status: false,
          delete: viewType == 'shen' ? false : true
        }"
...
<script>
import veStuStipendApi from '@/module/stu/stu/api/veStuStipendApi';
import veStuStipendEdit from './veStuStipendEdit';
import veStuStipendShow from './veStuStipendShow';
import veStuStipendTypeApi from '@/module/stu/stu/api/veStuStipendTypeApi';
export default {
  components: {
    veStuStipendEdit,
    veStuStipendShow
