<template>
  <edu-layout type="table" :extHeight="viewType == 'count' ? 50 : 0" topName="奖励查询">
    ...
    <div slot="table" class="right_table">
      <div>
        <edu-query ext="boxZybmbj" :nianji="false" ref="cwQuery" code="veStuReward" :do-filter="handleFilter">
          <template slot="search">
            <edu-query-item title="奖励类型" pname="d.type_id" textKey="title" pop="eq" stype="select" :datas="typeNodes" dtype="datas">
            </edu-query-item>
