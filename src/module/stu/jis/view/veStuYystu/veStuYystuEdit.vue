        ...
        >
          ...
          >
                            ...
                            <a-form-model-item label="预约开始时间" prop="yystartTime" required>
                                  <a-date-picker  v-model="veStuYystuVo.yystartTime" valueFormat="YYYY-MM-DD"  />
                               </a-form-model-item>
                            <a-form-model-item label="预约结束时间" prop="yyendTime" required>
                                  <a-date-picker  v-model="veStuYystuVo.yyendTime" valueFormat="YYYY-MM-DD"  />
                               </a-form-model-item>
                            ...
                            <a-form-model-item label="常规时间预约" prop="currentTime" required>
                                  <a-date-picker  v-model="veStuYystuVo.currentTime" valueFormat="YYYY-MM-DD"  />
                               </a-form-model-item>
                      </a-form-model>
        </edu-form>
  </div>
