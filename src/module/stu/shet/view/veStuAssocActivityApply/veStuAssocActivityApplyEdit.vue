        ...
        >
          ...
          >
                            ...
                            <a-form-model-item label="审核时间" prop="auditTime" required>
                                  <a-date-picker  v-model="veStuAssocActivityApplyVo.auditTime" valueFormat="YYYY-MM-DD"  />
                               </a-form-model-item>
                            <a-form-model-item label="申请时间" prop="addTime" required>
                                  <a-date-picker  v-model="veStuAssocActivityApplyVo.addTime" valueFormat="YYYY-MM-DD"  />
                               </a-form-model-item>
                      </a-form-model>
        </edu-form>
  </div>
