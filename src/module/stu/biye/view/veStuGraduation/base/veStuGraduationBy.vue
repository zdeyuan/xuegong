        ...
        <a-row>
          <a-col :span="12">
            <a-form-model-item label="结束学业年月" prop="jsxyDate" required>
              <a-input v-model="veStuGraduationVo.jsxyDate" :maxLength="0" placeholder="请输入结束学业年月" />
            </a-form-model-item>
          </a-col>
          <a-col :span="12">
        ...
        <a-row>
          ...
          <a-col :span="12">
            <a-form-model-item label="获毕业证书日期" prop="byDate">
              <a-date-picker v-model="veStuGraduationVo.byDate" valueFormat="YYYY-MM-DD" />
            </a-form-model-item>
          </a-col>
        </a-row>
        <a-row>
          ...
          <a-col :span="12">
            <a-form-model-item label="获结业证书日期" prop="jyDate">
              <a-date-picker v-model="veStuGraduationVo.jyDate" valueFormat="YYYY-MM-DD" />
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
...
<script>
import veStuGraduationApi from '@/module/stu/biye/api/veStuGraduationApi';
