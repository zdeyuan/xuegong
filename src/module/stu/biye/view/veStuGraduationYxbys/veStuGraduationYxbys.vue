    ...
    <div slot="table" class="right_table">
      <div>
       ...
       <span></span>
          ...
          <a-table-column title="结束学业年月" dataIndex="jsxyDate" width="150px"> </a-table-column>
      ...
      <!-- 编辑页 -->
      <veStuGraduationYxbysEdit v-if="showType == 'edit'" ref="veStuGraduationYxbysEdit" @onOk="editOk" @onCancel="editCancel">
...
<script>
import veStuGraduationYxbysApi from '@/module/stu/biye/api/veStuGraduationYxbysApi';
import veStuGraduationYxbysEdit from './veStuGraduationYxbysEdit';
