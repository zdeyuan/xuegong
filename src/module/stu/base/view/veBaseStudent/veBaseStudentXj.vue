<template>
  ...
  <edu-layout type="table">
    <div slot="table" class="right_table">
      <div>
        ...
        >
          <template slot="af_btn" slot-scope="{ row }">
            <edu-pms :code="'aaa'" name="学籍注册" ext="tedit" type="success" size="mini" @click="handleUpdate(row)"> </edu-pms>
            <edu-pms :code="'aaa'" name="照片采集" ext="tdo" type="success" size="mini" @click="doPhoto(row)"> </edu-pms>
          </template>
      ...
      <!-- 编辑页 -->
      <veBaseStudentEdit family v-if="showType == 'edit'" ref="veBaseStudentEdit" @onOk="editOk" @onCancel="editCancel"> </veBaseStudentEdit>
      <veBaseStudentPhoto v-if="showType == 'photo'" ref="veBaseStudentPhoto" @onOk="editOk" @onCancel="editCancel"> </veBaseStudentPhoto> </div
  ></edu-layout>
</template>
