    ...
    <div>
      <edu-query ref="cwQuery" code="veStuLiteraryAward" :do-filter="handleFilter">
        <template slot="search">
          <edu-query-item title="奖励类型" pname="d.item_id" textKey="name" pop="eq" stype="select" :datas="typeNodes" dtype="datas">
          </edu-query-item>
          <edu-query-item title="获奖者" pname="winner_Name" pop="like" stype="input"> </edu-query-item>
        </template>
      </edu-query>
      <edu-table
