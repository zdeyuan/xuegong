        ...
        <a-row>
          ...
          <a-col :span="12">
            <a-form-model-item label="级别id" prop="levelId" required>
              <edu-data v-model="veJkyProjectVo.levelId" stype="select" :datas="levelNodes" textKey="name" dtype="datas" />
            </a-form-model-item>
          </a-col>
        </a-row>
        <a-row>
          <a-col :span="12">
            <a-form-model-item label="立项组织" prop="createOragn" required>
              <edu-data v-model="veJkyProjectVo.createOragn" stype="select" textKey="name" :datas="organizes" dtype="datas" />
            </a-form-model-item>
          </a-col>
        ...
        <a-row>
          <a-col :span="12">
            <a-form-model-item label="项目开始时间" prop="startTime">
              <a-date-picker v-model="veJkyProjectVo.startTime" valueFormat="YYYY-MM-DD" />
            </a-form-model-item>
          </a-col>

          <a-col :span="12">
            <a-form-model-item label="项目结束时间" prop="endTime">
              <a-date-picker v-model="veJkyProjectVo.endTime" valueFormat="YYYY-MM-DD" />
            </a-form-model-item>
          </a-col>
        </a-row>
        <a-row>
...
<script>
import veJkyProjectApi from '@/module/research/rproject/api/veJkyProjectApi';
