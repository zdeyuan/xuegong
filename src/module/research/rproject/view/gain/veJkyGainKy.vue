        ...
        <edu-query ref="cwQuery" code="veJkyGain" :do-filter="handleFilter" @refreshBack="refreshBack">
          <template slot="search">
            ...
            <edu-query-item title="成果类型" stype="costom">
              <edu-tree-select @onChange="handleFilter" ref="eduTree" width="1.04167rem" :check="false" :nodes="categoryNodes"></edu-tree-select>
            </edu-query-item>
            <edu-query-item title="成果性质" pname="cgxz" stype="select" code="cgxz"> </edu-query-item>
          </template>
        </edu-query>
        <edu-table
          ref="veJkyGainTable"
...
<script>
import veJkyGainApi from '@/module/research/rproject/api/veJkyGainApi';

import veJkyLevelApi from '@/module/research/rbase/api/veJkyLevelApi';
import veJkyCategoryApi from '@/module/research/rbase/api/veJkyCategoryApi';
