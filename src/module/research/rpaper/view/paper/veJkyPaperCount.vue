        ...
        <edu-query ref="cwQuery" code="veJkyPaper" :do-filter="handleFilter">
          <template slot="search">
            <edu-query-item title="发布起始时间" pname="stime">
              <a-date-picker v-model="veJkyPaperQuery.sTime" valueFormat="YYYY-MM-DD" />
            </edu-query-item>
            <edu-query-item title="发布结束时间">
              <a-date-picker v-model="veJkyPaperQuery.eTime" valueFormat="YYYY-MM-DD" />
            </edu-query-item>
          </template>
        </edu-query>
        <div class="count-div">
...
<script>
import veJkyPaperApi from '@/module/research/rpaper/api/veJkyPaperApi';
